...
\begin{frame}
  ...
  \begin{Definition}
    \emph{Allgemeine Konzeptinklusionen} (General Concept Inclusions, GCIs) sind von der Form
    \begin{equation*}
      C \sqsubseteq D
    \end{equation*}
    wobei $C, D$ zwei $\ELbot$-Konzeptbeschreibungen sind.
...
\begin{frame}[label=current]
  ...
  \begin{block}{[Baader, Distel …]}
    Berechne Basis aller \emph{gültigen} GCIs.
  \end{block}
