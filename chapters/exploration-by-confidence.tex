...
as given in \Cref{alg:explore-implications} was to be able to explore sets of the form
...
$P_{i+1}^{1}$ comes from \Cref{eq:44} in \Cref{prop:easy-checking-confidence-closed}: if
