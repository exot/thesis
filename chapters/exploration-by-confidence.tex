...
we have to face here is how to implement \Cref{lst:explore-implications-1}, \ie
\begin{equation*}
...
\Cref{sec:poss-fast-expl} how this can be done.
...
Let us first consider the issue of avoiding the computation of closures under
