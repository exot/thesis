...
provides an approximative exploration of $\Th_{c}(\con K)$, and it depends crucially on
...
K)$ can be quite costly.  Eliminating these flaws thus seems highly desirable.
