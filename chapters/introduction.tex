...
$c$, for some chosen value $c \in [0,1]$.  We shall see that we can generalize most of the
results of Baader and Distel accordingly.  Finally, we shall apply our results to the data
sets we used for our experiments to show that certain errors in the input data can be
handled with out approach.
