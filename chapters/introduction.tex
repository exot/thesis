...
\emph{completing ontologies}~\cite{Sert07,BGSS07}, for which again attribute exploration
was used.  For this, GCIs of the form
\begin{equation*}
...
\todo[inline]{Write: previous connections between FCA and DL (Sertkaya, Rudolph, Power
  Context Families, RCA)}%
