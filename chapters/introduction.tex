...
\todo[inline]{Write: previous connections between FCA and DL (Baader, Sertkaya, RCA,
  Rudolph, Power Context Families)}%
\todo[inline]{Write: mention Luxenburger}%
\todo[inline]{Write: mention Burmeister (attribute exploration with incomplete
  knowledge)}%
\todo[inline]{Write: mention Fuzzy-FCA and Fuzzy-DL}%
