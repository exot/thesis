...
\begin{Proof}
  ...
  subinterpretation of $\mathcal{I}_{\ell}$, we obtain from \Cref{lem:Felix-6.14}, it is
  ...
  Therefore, we have established the validity of \Cref{eq:56}, and thus can infer that
  ...
  and $M_{i}$ are chosen suitably.  Thus, to show \Cref{eq:57} it suffices to verify that
  \begin{equation}
    \label{eq:58}
