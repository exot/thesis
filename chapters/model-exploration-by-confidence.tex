...
\begin{equation*}
  \Th_{c}(\mathcal{J}, \mathcal{I}) := \set{ (C \sqsubseteq D) \in \Th(\mathcal{J}
    \setminus \mathcal{I}) \mid \abs{ (C \sqcap D)^{\mathcal{J}} \cap \Delta^{\mathcal{I}}
    } \ge c \cdot \abs{ C^{\mathcal{J}} \cap \Delta^{\mathcal{I}} } }.
\end{equation*}
We then want to describe a finite base of $\Th_{c}(\mathcal{J}, \mathcal{I})$.

% In our later considerations, $\mathcal{I}$ will be a connected interpretation of
% $\mathcal{J}$, but the results in this section also apply to the more general situation
% where $\mathcal{I}$ is just a subinterpretation of $\mathcal{J}$.
