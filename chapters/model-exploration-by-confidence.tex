...
Let us consider this in more detail: observe that the computation of $P_{i+1}^{1}$ in our
hypothetical adaption of \Cref{alg:confident-base-gcis/trusted-objects} would \emph{not}
be correct if the lectically next intent after $P_{i}$ of the current working context
$\con K_{i+1} \div \con L_{i+1}$ in \Cref{alg:confident-base-gcis/trusted-objects} is not
an intent of the working context of our hypothetical adaption.  In other words, if we
denote the working context of our adapted algorithm by $\con K_{i+1} \div \bar{\con
