...
set $M_{\mathcal{I}}$ first.  Instead, we want that the set $M_{\mathcal{I}}$ is computed
successively during the run of the algorithm.  In this way, we can immediately start with
computing valid GCIs of $\mathcal{I}$, and do not have to wait for $M_{\mathcal{I}}$ to be
computed completely.
