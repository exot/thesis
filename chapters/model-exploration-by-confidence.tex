...
\Cref{alg:base/growing-set-of-attributes}, we cannot discard sets $P_{i}$ which are
intents of the current working context $\con K_{i}$, as they may become non-intents later
on in the run of the algorithm.
