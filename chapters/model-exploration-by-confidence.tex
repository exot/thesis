...
successors, and so on) in $\mathcal{I}_{\mathsf{back}}$, although they may not be
necessary as part of the counterexample; otherwise, elements in $\mathcal{I}$ may serve as
...
successors $x$ has in $\mathcal{I}_{\mathsf{back}}$.  Otherwise, there is the danger that
...
confidence shall be based on the computation of bases of GCIs with high confidence.
...
bases of interpretations which contain untrusted elements.
