...
\begin{Theorem}[Theorem~5.21 of~\cite{Diss-Felix}]
  ...
  base of $\mathcal{I}$.  Define $d \in \NN_0$ as in \Cref{lem:Felix-lemma-5.5}.  Then
  \begin{align*}
    \mathcal{B}_d &:= \set{ C_d \sqsubseteq (C^{\mathcal{I}\mathcal{I}})_d \mid (C
      \sqsubseteq D) \in \mathcal{B} } \cup {} \\
    &\phantom{{}:={}} \set{ (X^{\mathcal{I}})_d \sqsubseteq (X^{\mathcal{I}})_{d+1} \mid X
      \subseteq \Delta^{\mathcal{I}}, X \neq \emptyset }
  \end{align*}
  is a finite \ELbot base of $\mathcal{I}$.
\end{Theorem}
...
\begin{equation*}
  \mathcal{X}_d := \set{ (X^{\mathcal{I}})_d \sqsubseteq (X^{\mathcal{I}})_{d+1} \mid X
    \subseteq \Delta^{\mathcal{I}}, X \neq \emptyset }
\end{equation*}
satisfies for all $X \subseteq \Delta^{\mathcal{I}}$
\begin{enumerate}[i. ]
\item $\mathcal{X}_d \models ( (X^{\mathcal{I}})_k \sqsubseteq (X^{\mathcal{I}})_{k+1} )$
  for all $k \in \NN_0, k \geq d$, and
\item $\mathcal{X}_d \models ( (X^{\mathcal{I}})_d \sqsubseteq X^{\mathcal{I}} )$.
\end{enumerate}
...
observe that if $\mathcal{J}$ is a finite interpretation\todo{enough, since \ELbot has
  finite model property}\ such that $\mathcal{J} \models \mathcal{X}_d$, then by the first
property
\begin{equation*}
...
therefore $\mathcal{X}_d \models ( (X^{\mathcal{I}})_d \sqsubseteq X^{\mathcal{I}} )$.

But then if $(C \sqsubseteq D) \in \mathcal{B}$, then $\mathcal{B}_d \models (
(C^{\mathcal{I}\mathcal{I}})_d \sqsubseteq C^{\mathcal{I}\mathcal{I}})$ by the argument
just shown, and $\mathcal{B}_d \models ( C_d \sqsubseteq (C^{\mathcal{I}\mathcal{I}})_d
)$, because this GCI is contained in $\mathcal{B}_d$.  Thus
\begin{equation*}
  \mathcal{B}_d \models ( C \sqsubseteq C_d \sqsubseteq (C^{\mathcal{I}\mathcal{I}})_d
  \sqsubseteq C^{\mathcal{I}\mathcal{I}}),
\end{equation*}
and \Cref{lem:simple-entailment-with-mmsc} yields $\mathcal{B}_d \models (C \sqsubseteq
D)$.  Thus, $\mathcal{B}_d$ entails all GCIs in $\mathcal{B}$, and since $\mathcal{B}$ is
complete for $\mathcal{I}$, $\mathcal{B}_d$ is complete for $\mathcal{I}$ as well.
