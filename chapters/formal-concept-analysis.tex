...
\dots\todo{find which philosopher this was}, which claims that concepts are uniquely
determined by their \emph{extension}, \ie all objects which they cover, or their
\emph{intention}, a description of the concept in terms of attributes.\todo{too vague,
  make this better}
...
\todo[inline]{Write: example of concept lattice}
