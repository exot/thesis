...
respectively.  Furthermore, every finite ordered set $(P, \le)$ in which the supremum
exists for each $Q \subseteq P$ is already a lattice, as the infimum is then given by
\begin{equation*}
...
\begin{Definition}[Contextual Derivation]
  Let $\con K = (G, M, I)$ be a formal context and let $A \subseteq G$ be a set of objects.
\end{Definition}
