...
\begin{Definition}[Pseudo-Intents]
  ...
  Let $M$ be a set, $\con K$ a formal context with attribute set $M$ and let $\mathcal{K}$
  be sets of implications on $M$.  Then a set $P \subseteq M$ is called a
  \emph{$\mathcal{K}$-pseudo-intent} of $\con K$ if and only if
  \begin{enumerate}[i. ]
  \item $P \neq \mathcal{L}(P)$,
  \item $P = \mathcal{K}(P)$, and
  \item for each $\mathcal{K}$-pseudo-intent $Q$ of $\con K$ satisfying $Q \subsetneq P$,
