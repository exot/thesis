...
On the other hand, these results are not sufficient to prove that the computation of the
canonical base itself is hard, and this thus remains to be an open research problem.
