...
\begin{Definition}[Theory with respect to a Threshold]
  ...
  the set\todo{not consistent with the definition of $\Th(\mathcal{I})$; make the
    definition of $\Th(\mathcal{I})$ into using \ELgfpbot only}
  \begin{equation*}
