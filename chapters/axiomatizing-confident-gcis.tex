...
Among the GCIs contained in $\mathcal{B}_\Idbpedia$ there exist some which convey the
impression of being redundant, either for themselves, like
\begin{gather*}
...
\end{gather*}
In the latter GCIs, the concept name \textsf{Person} appears quite often, although it is
quite clear from the construction of $\Idbpedia$ that
\begin{equation}
  \label{eq:23}
