...
that the set
\begin{equation*}
  \set{ \bigsqcap U \sqsubseteq (\bigsqcap U)^{\mathcal{I}\mathcal{I}} \mid (U \to U'')
    \in \Can(\con K_{\mathcal{I}}, \pr_{M_{\mathcal{I}}}(\mathcal{B})) }
\end{equation*}
is complete for $\mathcal{I}$.

This result already appeared in \cite[Theorem~5.12]{Diss-Felix}, however only for the case
that $\mathcal{B}$ contained valid GCIs of $\mathcal{I}$ only.  As a first step, we shall
generalize this result to also cover the case that $\mathcal{B}$ contains arbitrary GCIs.

\begin{Theorem}
  \label{thm:gci-completion-simple-version}
  Let $\mathcal{I}$ be a finite interpretation over $N_C$ and $N_R$, and let $\mathcal{B}$
  be a set of GCIs over $N_C$ and $N_R$.  Let $\mathcal{L} \subseteq \Th(\con
  K_{\mathcal{I}})$ such that
  \begin{enumerate}[i. ]
  \item\label{item:18} $\mathcal{L} \cup \pr_{M_{\mathcal{I}}}(\mathcal{B})$ is complete
    for $\Th(\con K_{\mathcal{I}})$, and
...
\begin{Proof}
  ...
  \begin{enumerate}[i. ]
  \item $\con K_{\mathcal{J}, M_{\mathcal{I}}} \models (\mathcal{L} \cup \pr_{M_{\mathcal{I}}}(\mathcal{B}))$,
  \item $\con K_{\mathcal{J}, M_{\mathcal{I}}} \models (V \to
    V^{\prime_{\mathcal{I}}\prime_{\mathcal{I}}})$ for all $V \subseteq M_{\mathcal{I}}$,
    and finally
  \item $\mathcal{J} \models (\bigsqcap V \sqsubseteq (\bigsqcap
    V)^{\mathcal{I}\mathcal{I}})$ for all $V \subseteq M_{\mathcal{I}}$.
  \end{enumerate}
  ~\todo[inline]{continue}
\end{Proof}

\todo[inline]{Write: MATH-AL-08-2012/7}
