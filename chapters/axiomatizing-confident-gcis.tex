...
\begin{Proof}[\Cref{thm:minimal-cardinality}]
  ...
  \todo[inline]{Show that $\mathcal{C}$ entails something like $\bigsqcap U \sqsubseteq A$
  for some $A \in M_{\mathcal{I}} \setminus U$.}
  ...
  \Cref{thm:canonical-base-with-arbitrary-background-knowledge} we obtain that
  \begin{equation*}
