...
\Cref{thm:Felix-5.18}, which was \cite[Theorem~5.18]{Diss-Felix}.  Therefore, what we are
about to show is a generalization this result, and for this we shall use the argumentation
of the proof of \cite[Theorem~5.18]{Diss-Felix} and adapt it to our setting.  This is the
